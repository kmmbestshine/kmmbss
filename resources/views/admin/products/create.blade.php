		...
		<form action="{{ isset($product) ? route('products.update', $product->slug) : route('products.store')}}" method="post" enctype="multipart/form-data">
			...
			<!-- product website -->
				<div class="form-group">
					...
					<input type="text" name="website" id="website" class="form-control @error('website') is-invalid @enderror" value="{{ isset($product) ? $product->website :  old('website') }}">
				...
				<div class="form-group">
					...
					<input type="text" name="username" id="username" class="form-control @error('username') is-invalid @enderror" value="{{ isset($product) ? $product->username :  old('username') }}">
				...
				<div class="form-group">
					...
					<input type="text" name="password" id="password" class="form-control @error('password') is-invalid @enderror" value="{{ isset($product) ? $product->password :  old('password') }}">
