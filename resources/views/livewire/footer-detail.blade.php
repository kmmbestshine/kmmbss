<section class="footer-section">
	...
	<div class="social-links-warp">
		<div class="container">
			...
			@endif
			<p class="text-white text-center mt-5">Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | Developed By <a href="https://bestshinesoftwaresolutions.co.in" target="_blank">Bestshine Software Solutions</a></p>
