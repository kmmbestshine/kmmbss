			...
			<div class="row">
				...
				<div class="col-lg-6 product-details">
					...
					@endif
						...
						<button type="submit" class="site-btn">Add To Cart For Demo</button>
					</form>
					<hr>
					<h3><p>Click  For Live Demo.</p></h3>

					<a href="{{$product->sitename}}/" target="_blank" rel="noopener noreferrer">Website :{{$product->sitename}}</a>
					
					<h4> <p>Login Credential :- <br> Username :{{$product->username}}   <br> Password : {{$product->password}} <br></p></h4>
						...
						<div class="panel">
							...
							<div id="collapse3" class="collapse" aria-labelledby="headingThree" data-parent="#accordion">
								<div class="panel-body">
									...
									<p>Cash on Delivery Available<br>Hand Over Software <span>3 - 4 days</span></p>
