			...
			<div class="col-lg-8 order-2 order-lg-1">
				<form class="checkout-form" action="{{ route('checkout.store') }}" method="post">
					...
					<div class="row address-inputs">
						...
						<div class="col-md-12">
							<input type="text" name="notes" placeholder="Notes. Training will be available Monday To Friday 9 AM to 7 PM and Online Support 24 Hrs x 7 days" value="{{ auth()->user()->notes }}">
						</div>
					</div>
					...
					<div class="cf-title">Payment</div>
						<ul class="payment-list">
							...
							<li>
								...
								Please Click For Demo Order. You Will Not Pay For Demo Software. Software Hand Over duration : 3 days to 5 days.
							</li>
						</ul>
					<button type="submit" class="site-btn submit-order-btn">Demo Order</button>
				</form>
			</div>
